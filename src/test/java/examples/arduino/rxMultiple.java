...
//Se crea una variable tipo Xsystem_Arduino

    static Xsystem_Arduino ino = new Xsystem_Arduino();
    /**
     * Se crea una instancia de la clase Xsystem_MultiMessage, indicando la
 implementacion de 4 sensores
     */
    static Xsystem_MultiMessage multi = new Xsystem_MultiMessage(4, ino);
