 ...
 */
package com.xsystem.liveinterfaces;

import com.xsystem.Xsystem_Arduino;
import com.xsystem.Xsystem_DataBuffer;
import com.xsystem.Xsystem_MultiMessage;
import com.xsystem.events.DataInsertionEvent;
import com.xsystem.events.DataInsertionListener;
...
public class PanamaHitek_TimeLineChart extends JPanel {
    ...
    private Xsystem_Arduino ino = null;
    private Xsystem_MultiMessage multi;
    private Xsystem_DataBuffer buffer;
     ...
     *
     * @param buffer Instancia de la clase Xsystem_DataBuffer
     ...
     * boolean...)
     */
    public void setDataBuffer(Xsystem_DataBuffer buffer) throws Exception {
        this.buffer = buffer;
     ...
     * String, boolean, char...
     */
    public void setDataBuffer(Xsystem_DataBuffer buffer, int index) throws Exception {
        if (index < 0) {
     ...
     */
    public void setDataBuffer(Xsystem_DataBuffer buffer, Integer[] bufferIndexes) throws Exception {
        this.buffer = buffer;
        indexList = new ArrayList<>();
