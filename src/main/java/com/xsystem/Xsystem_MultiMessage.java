 ...
 */
public class Xsystem_MultiMessage {

    //Variables 
    private static int inputMesages = 0;
    private static List<String> inputBuffer;
    private final Xsystem_Arduino arduinoObject;
     ...
     * @param arduinoObject Un objeto de la clase Xsystem_Arduino con el
 cual se ha iniciado una conexión con Arduino
     */
    public Xsystem_MultiMessage(int inputMessages, Xsystem_Arduino arduinoObject) {
